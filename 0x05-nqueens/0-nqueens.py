#!/usr/bin/python3
""" N QUEENS ALGORITHM_WITH_BACKTRACKING (RECURSION_INSIDE_LOOP) """
import sys


class NQueen:
    """ Class_for_solving N Queen_Problem """
    ...
    def place(self, k, i):
        """ This checks if k Queen can be_placed in i column (True)
            or if the are attacking queens in row_or diagonal (False)
        """
    ...
    def nQueen(self, k):
        """ Tries to place_every queen in the_board
            Args:
            k: starting queen from which_to evaluate (should be 1)
        """
